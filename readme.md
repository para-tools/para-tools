...
This build may also checkout the matching documentation 'para-tools.github.io.git' into the **`_externals/`** subdirectory which is ignored by the main git.  This permits it to automatically update the documentation on a release.
